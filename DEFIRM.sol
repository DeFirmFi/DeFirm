...
contract DeFirm is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("DeFirm", "DEFIRM", uint8(DECIMALS)) Ownable() {
        ...
        _gonBalances[warchestReceiver] = TOTAL_GONS;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);

        _isFeeExempt[warchestReceiver] = true;
        _isFeeExempt[address(this)] = true;

        _transferOwnership(warchestReceiver);
        emit Transfer(address(0x0), warchestReceiver, _totalSupply);
    }
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(warchestFee).div(feeDenominator)
        );
    ...
    function withdrawAllToWarchest() external swapping onlyOwner {
